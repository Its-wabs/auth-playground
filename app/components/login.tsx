                ...
                <div className="flex flex-col gap-4 text-center">
                    <div className="overflow-hidden">
                        <p className="text-sm uppercase tracking-wider text-black/60">
                            New here? <a onClick={() => window.dispatchEvent(new Event("show-signup"))} className="font-semibold cursor-pointer text-black underline underline-offset-4 hover:text-black/60 transition-colors">Signup</a>
                        </p>
                    </div>
                    
                    <div className="overflow-hidden">
                        <p className="text-sm uppercase tracking-wider text-black/60">
                            Forgot your password? <a href="#" className="font-semibold text-black underline underline-offset-4 hover:text-black/60 transition-colors">Reset password</a>
                        </p>
                    </div>
                </div>
            </div>
